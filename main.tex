...
\begin{figure}[H]
	...
	\subfloat[][$t=2$]{\includegraphics[width=.3\textwidth]{./fig/sd_s2.png}}
	\\
	\subfloat[][$t=3$]{\includegraphics[width=.3\textwidth]{./fig/sd_s3.png}}
	\subfloat[][$t=4$]{\includegraphics[width=.3\textwidth]{./fig/sd_s4.png}}
	\subfloat[][$t=5$]{\includegraphics[width=.3\textwidth]{./fig/sd_s5.png}}
